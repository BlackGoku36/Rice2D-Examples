...
var InterpTest = function() {
	this.ww = rice2d_Window.getWindowSize().width;
	this.d = 5;
	this.t = 0.0;
	this.r = 50;
	this.c7 = new kha_math_Vector2();
	this.c6 = new kha_math_Vector2();
	this.c5 = new kha_math_Vector2();
	this.c4 = new kha_math_Vector2();
	this.c3 = new kha_math_Vector2();
	this.c2 = new kha_math_Vector2();
	this.c1 = new kha_math_Vector2();
	this.kb = rice2d_Input.getKeyboard();
	rice2d_App.notifyOnUpdate($bind(this,this.update));
	rice2d_App.notifyOnRender($bind(this,this.render));
};
$hxClasses["InterpTest"] = InterpTest;
InterpTest.__name__ = true;
InterpTest.prototype = {
	kb: null
	,c1: null
	,c2: null
	,c3: null
	...
	,update: function() {
		if(this.t <= this.d) {
			this.c1 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,60),new kha_math_Vector2(this.ww - this.r,60),rice2d_Tween.easeLinear(this.t / this.d));
			this.c2 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,160),new kha_math_Vector2(this.ww - this.r,160),rice2d_Tween.easeSineIn(this.t / this.d));
			this.c3 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,260),new kha_math_Vector2(this.ww - this.r,260),rice2d_Tween.easeSineOut(this.t / this.d));
			this.c4 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,360),new kha_math_Vector2(this.ww - this.r,360),rice2d_Tween.easeSineInOut(this.t / this.d));
			this.c5 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,460),new kha_math_Vector2(this.ww - this.r,460),rice2d_Tween.easeExpoIn(this.t / this.d));
			this.c6 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,560),new kha_math_Vector2(this.ww - this.r,560),rice2d_Tween.easeExpoOut(this.t / this.d));
			this.c7 = rice2d_math_Vec2Extension.lerp(kha_math_Vector2,new kha_math_Vector2(0,660),new kha_math_Vector2(this.ww - this.r,660),rice2d_Tween.easeExpoInOut(this.t / this.d));
		}
		this.t += 0.0166666666666666664;
	}
	,render: function(canvas) {
		...
		g.drawString("And more..",this.ww / 2 - g.get_font().width(g.get_fontSize(),"And more..") / 2,740);
		g.set_color(-16776961);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c1.x,this.c1.y,this.r);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c2.x,this.c2.y,this.r);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c3.x,this.c3.y,this.r);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c4.x,this.c4.y,this.r);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c5.x,this.c5.y,this.r);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c6.x,this.c6.y,this.r);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.c7.x,this.c7.y,this.r);
		g.set_color(col);
	}
	,__class__: InterpTest
};
var Lambda = function() { };
...
var rice2d_Tween = function(tweenData) {
	this.tween = tweenData;
	this.tween.deltaTime = 0;
	this.tween.done = false;
};
$hxClasses["rice2d.Tween"] = rice2d_Tween;
rice2d_Tween.__name__ = true;
rice2d_Tween.easeLinear = function(k) {
	return k;
};
rice2d_Tween.easeSineIn = function(k) {
	if(k == 0) {
		return 0;
	} else if(k == 1) {
		return 1;
...
rice2d_Tween.easeSineOut = function(k) {
	if(k == 0) {
		return 0;
	} else if(k == 1) {
		return 1;
...
rice2d_Tween.easeSineInOut = function(k) {
	if(k == 0) {
		return 0;
	} else if(k == 1) {
		return 1;
...
rice2d_Tween.easeQuadIn = function(k) {
	return k * k;
};
rice2d_Tween.easeQuadOut = function(k) {
	return -k * (k - 2);
};
rice2d_Tween.easeQuadInOut = function(k) {
	if(k < 0.5) {
		return 2 * k * k;
	} else {
		return -2 * (--k * k) + 1;
...
rice2d_Tween.easeCubicIn = function(k) {
	return k * k * k;
};
rice2d_Tween.easeCubicOut = function(k) {
	return --k * k * k + 1;
};
rice2d_Tween.easeCubicInOut = function(k) {
	if((k *= 2) < 1) {
		return 0.5 * k * k * k;
	} else {
...
rice2d_Tween.easeQuartIn = function(k) {
	return (k *= k) * k;
};
rice2d_Tween.easeQuartOut = function(k) {
	k = --k * k;
	return 1 - k * k;
};
rice2d_Tween.easeQuartInOut = function(k) {
	if((k *= 2) < 1) {
		return 0.5 * (k *= k) * k;
	} else {
		k = (k -= 2) * k;
...
rice2d_Tween.easeQuintIn = function(k) {
	return k * (k *= k) * k;
};
rice2d_Tween.easeQuintOut = function(k) {
	return --k * (k *= k) * k + 1;
};
rice2d_Tween.easeQuintInOut = function(k) {
	if((k *= 2) < 1) {
		return 0.5 * k * (k *= k) * k;
	} else {
...
rice2d_Tween.easeExpoIn = function(k) {
	if(k == 0) {
		return 0;
	} else {
...
rice2d_Tween.easeExpoOut = function(k) {
	if(k == 1) {
		return 1;
	} else {
...
rice2d_Tween.easeExpoInOut = function(k) {
	if(k == 0) {
		return 0;
	}
	if(k == 1) {
...
rice2d_Tween.easeCircIn = function(k) {
	return -(Math.sqrt(1 - k * k) - 1);
};
rice2d_Tween.easeCircOut = function(k) {
	return Math.sqrt(1 - (k - 1) * (k - 1));
};
rice2d_Tween.easeCircInOut = function(k) {
	if(k <= .5) {
...
rice2d_Tween.easeBackIn = function(k) {
	if(k == 0) {
		return 0;
	} else if(k == 1) {
		return 1;
...
rice2d_Tween.easeBackOut = function(k) {
	if(k == 0) {
		return 0;
	} else if(k == 1) {
		return 1;
...
rice2d_Tween.easeBackInOut = function(k) {
	if(k == 0) {
		return 0;
	} else if(k == 1) {
		return 1;
...
rice2d_Tween.prototype = {
	tween: null
	,update: function() {
		var xy = { x : this.tween.start.x, y : this.tween.start.y, rot : this.tween.rotS};
		if(!this.tween.done && !this.tween.paused) {
			this.tween.deltaTime += 0.0166666666666666664;
			if(this.tween.deltaTime >= this.tween.duration) {
				this.tween.done = true;
				if(this.tween.onDone != null) {
					this.tween.onDone(this);
				}
			} else {
				var t = this.tween.deltaTime / this.tween.duration;
				xy.x = (1 - rice2d_Tween.eases[this.tween.ease](t)) * this.tween.start.x + rice2d_Tween.eases[this.tween.ease](t) * this.tween.end.x;
				xy.y = (1 - rice2d_Tween.eases[this.tween.ease](t)) * this.tween.start.y + rice2d_Tween.eases[this.tween.ease](t) * this.tween.end.y;
				if(this.tween.rotS != null || this.tween.rotE != null) {
					xy.rot = (1 - rice2d_Tween.eases[this.tween.ease](t)) * this.tween.rotS + rice2d_Tween.eases[this.tween.ease](t) * this.tween.rotE;
				}
			}
		}
		...
		if(this.tween.done) {
			xy.x = this.tween.end.x;
			xy.y = this.tween.end.y;
			xy.rot = this.tween.rotS;
		}
		return xy;
	}
	,restart: function(newTween) {
		if(newTween != null) {
			this.tween = newTween;
		}
		this.tween.done = false;
...
var rice2d_math_MathExtension = function() { };
$hxClasses["rice2d.math.MathExtension"] = rice2d_math_MathExtension;
rice2d_math_MathExtension.__name__ = true;
rice2d_math_MathExtension.clamp = function(_,value,min,max) {
	if(value < min) {
		return min;
	} else if(value > max) {
		return max;
...
rice2d_math_MathExtension.lerp = function(_,start,end,dt) {
	return (1 - dt) * start + dt * end;
};
var rice2d_math_Vec2Extension = function() { };
$hxClasses["rice2d.math.Vec2Extension"] = rice2d_math_Vec2Extension;
rice2d_math_Vec2Extension.__name__ = true;
rice2d_math_Vec2Extension.getLengthSq = function(_,a) {
	return a.x * a.x + a.y * a.y;
};
rice2d_math_Vec2Extension.getCenter = function(_,pos,width,height) {
	return new kha_math_Vector2(pos.x - width / 2,pos.y - height / 2);
};
rice2d_math_Vec2Extension.lookAt = function(_,from,to) {
	var x = from.x - to.x;
	var y = from.y - to.y;
	if(y == null) {
		y = 0;
	...
	var v = new kha_math_Vector2(x,y);
...
rice2d_math_Vec2Extension.clamp = function(_,value,min,max) {
	value.x = rice2d_math_MathExtension.clamp(Math,value.x,min.x,max.x);
	value.y = rice2d_math_MathExtension.clamp(Math,value.y,min.y,max.y);
	return value;
};
rice2d_math_Vec2Extension.lerp = function(_,start,end,dt) {
	return new kha_math_Vector2(rice2d_math_MathExtension.lerp(Math,start.x,end.x,dt),rice2d_math_MathExtension.lerp(Math,start.y,end.y,dt));
};
...
rice2d_Tween.eases = [rice2d_Tween.easeLinear,rice2d_Tween.easeSineIn,rice2d_Tween.easeSineOut,rice2d_Tween.easeSineInOut,rice2d_Tween.easeQuadIn,rice2d_Tween.easeQuadOut,rice2d_Tween.easeQuadInOut,rice2d_Tween.easeCubicIn,rice2d_Tween.easeCubicOut,rice2d_Tween.easeCubicInOut,rice2d_Tween.easeQuartIn,rice2d_Tween.easeQuartOut,rice2d_Tween.easeQuartInOut,rice2d_Tween.easeQuintIn,rice2d_Tween.easeQuintOut,rice2d_Tween.easeQuintInOut,rice2d_Tween.easeExpoIn,rice2d_Tween.easeExpoOut,rice2d_Tween.easeExpoInOut,rice2d_Tween.easeCircIn,rice2d_Tween.easeCircOut,rice2d_Tween.easeCircInOut,rice2d_Tween.easeBackIn,rice2d_Tween.easeBackOut,rice2d_Tween.easeBackInOut];
