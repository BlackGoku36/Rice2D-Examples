...
Math.__name__ = true;
var CollisionType = $hxEnums["CollisionType"] = { __ename__ : true, __constructs__ : ["RectRect","CircleCircle","CircleRect"]
	,RectRect: {_hx_index:0,__enum__:"CollisionType",toString:$estr}
	,CircleCircle: {_hx_index:1,__enum__:"CollisionType",toString:$estr}
	,CircleRect: {_hx_index:2,__enum__:"CollisionType",toString:$estr}
};
var OverlapTest = function() {
	this.collisionType = CollisionType.RectRect;
	this.collide = false;
	this.circle2Radius = 100;
	this.circle1Radius = 100;
	this.circle1Pos = new kha_math_Vector2();
	this.rect2Height = 200;
	this.rect2Width = 200;
	this.rect2Pos = new kha_math_Vector2();
	this.rect1Height = 200;
	this.rect1Width = 200;
	this.rect1Pos = new kha_math_Vector2();
	this.mouse = rice2d_Input.getMouse();
	this.kb = rice2d_Input.getKeyboard();
	this.circle2Pos = rice2d_Window.getCenter();
	var tmp = rice2d_Window.getCenter().x;
	this.rect2Pos.x = tmp - this.rect2Width / 2;
	var tmp = rice2d_Window.getCenter().y;
	this.rect2Pos.y = tmp - this.rect2Height / 2;
	rice2d_App.notifyOnUpdate($bind(this,this.update));
	rice2d_App.notifyOnRender($bind(this,this.render));
};
$hxClasses["OverlapTest"] = OverlapTest;
OverlapTest.__name__ = true;
OverlapTest.prototype = {
	kb: null
	,mouse: null
	,rect1Pos: null
	,rect1Width: null
	...
	,collisionType: null
	,update: function() {
		if(this.kb.started(49)) {
			this.collisionType = CollisionType.RectRect;
		} else if(this.kb.started(50)) {
			this.collisionType = CollisionType.CircleCircle;
		} else if(this.kb.started(51)) {
			this.collisionType = CollisionType.CircleRect;
		}
		switch(this.collisionType._hx_index) {
		case 0:
			this.rect1Pos.x = this.mouse.x;
			this.rect1Pos.y = this.mouse.y;
			this.collide = rice2d_Overlap.RectvsRect(this.rect1Pos,this.rect1Width,this.rect1Height,this.rect2Pos,this.rect2Width,this.rect2Height);
			break;
		case 1:
			this.circle1Pos.x = this.mouse.x;
			this.circle1Pos.y = this.mouse.y;
			this.collide = rice2d_Overlap.CirclevsCircle(this.circle1Pos,this.circle1Radius,this.circle2Pos,this.circle2Radius);
			break;
		case 2:
			this.circle1Pos.x = this.mouse.x;
			this.circle1Pos.y = this.mouse.y;
			this.collide = rice2d_Overlap.CirclevsRect(this.circle1Pos,this.circle1Radius,this.rect2Pos,this.rect2Width,this.rect2Height);
			break;
		}
	}
	,render: function(canvas) {
		...
		switch(this.collisionType._hx_index) {
		case 0:
			g.fillRect(this.rect1Pos.x,this.rect1Pos.y,this.rect1Width,this.rect1Height);
			g.fillRect(this.rect2Pos.x,this.rect2Pos.y,this.rect2Width,this.rect2Height);
			break;
		case 1:
			kha_graphics2_GraphicsExtension.fillCircle(g,this.circle1Pos.x,this.circle1Pos.y,this.circle1Radius);
			kha_graphics2_GraphicsExtension.fillCircle(g,this.circle2Pos.x,this.circle2Pos.y,this.circle2Radius);
			break;
		case 2:
			kha_graphics2_GraphicsExtension.fillCircle(g,this.circle1Pos.x,this.circle1Pos.y,this.circle1Radius);
			g.fillRect(this.rect2Pos.x,this.rect2Pos.y,this.rect2Width,this.rect2Height);
