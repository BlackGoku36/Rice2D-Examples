...
var ShaderTest = function() {
	this.time = 0.0;
	this.shader = new rice2d_shaders_Shader(new rice2d_shaders_ShaderData(kha_Shaders.test_frag,1));
	this.timeCL = this.shader.getPipeline().getConstantLocation("time");
	rice2d_App.notifyOnUpdate($bind(this,this.update));
	rice2d_App.notifyOnRender($bind(this,this.render));
};
$hxClasses["ShaderTest"] = ShaderTest;
ShaderTest.__name__ = true;
ShaderTest.prototype = {
	shader: null
	,time: null
	,timeCL: null
	,update: function() {
	...
	,render: function(canvas) {
		var g = canvas.get_g2();
		var col = g.get_color();
		var w = rice2d_Window.getCenter();
		this.shader.begin(canvas);
		canvas.get_g4().setFloat(this.timeCL,this.time);
		kha_graphics2_GraphicsExtension.fillCircle(g,w.x,w.y,150);
		this.shader.end(canvas);
		g.set_color(col);
	}
	,__class__: ShaderTest
};
var Std = function() { };
$hxClasses["Std"] = Std;
Std.__name__ = true;
...
var rice2d_shaders_ShaderData = function(fragmentShader,type) {
	this.fragmentShader = fragmentShader;
	this.type = type;
};
$hxClasses["rice2d.shaders.ShaderData"] = rice2d_shaders_ShaderData;
rice2d_shaders_ShaderData.__name__ = true;
rice2d_shaders_ShaderData.prototype = {
	fragmentShader: null
	,type: null
	,__class__: rice2d_shaders_ShaderData
};
var rice2d_shaders_ConstantData = function(name,type,val,bool,tex) {
	this.name = name;
	this.type = type;
	this.val = val;
	this.bool = bool;
...
$hxClasses["rice2d.shaders.ConstantData"] = rice2d_shaders_ConstantData;
rice2d_shaders_ConstantData.__name__ = true;
rice2d_shaders_ConstantData.prototype = {
	name: null
	,type: null
	,val: null
	,bool: null
	,tex: null
	,__class__: rice2d_shaders_ConstantData
};
