...
var InputTest = function() {
	...
	this.circlePos = new kha_math_Vector2();
	this.squareSide = 100;
	this.squarePos = new kha_math_Vector2();
...
InputTest.prototype = {
	...
	,update: function() {
		if(this.kb.down(87)) {
			this.squarePos.y -= 5;
		} else if(this.kb.down(83)) {
			this.squarePos.y += 5;
		} else if(this.kb.down(65)) {
			this.squarePos.x -= 5;
		} else if(this.kb.down(68)) {
			this.squarePos.x += 5;
		}
		this.circlePos.x = this.mouse.x;
		this.circlePos.y = this.mouse.y;
	}
	,render: function(canvas) {
		var g = canvas.get_g2();
		var col = g.get_color();
		g.set_color(-16776961);
		kha_graphics2_GraphicsExtension.fillCircle(g,this.circlePos.x,this.circlePos.y,this.circleRadius);
		g.set_color(-65536);
		g.fillRect(this.squarePos.x,this.squarePos.y,this.squareSide,this.squareSide);
		g.set_color(col);
	}
	,__class__: InputTest
};
